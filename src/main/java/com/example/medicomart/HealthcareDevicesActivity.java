...
public class HealthcareDevicesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthcare_devices);
        ...
        FirebaseRecyclerOptions<MainModel> options = new FirebaseRecyclerOptions.Builder<MainModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("healthcaredevices"), MainModel.class)
                .build();

        mainAdepter = new MainAdepter(options);
        recyclerView.setAdapter(mainAdepter);

        FirebaseDatabase.getInstance().getReference().child("healthcaredevices")
        ...
        mainAdepter.setOnItemClickListener(model -> {
            Intent intent = new Intent(HealthcareDevicesActivity.this, DetailsViewActivity.class);
