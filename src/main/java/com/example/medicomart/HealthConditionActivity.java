...
public class HealthConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<MainModel> options = new FirebaseRecyclerOptions.Builder<MainModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("healthcondition"), MainModel.class)
                .build();

        mainAdepter = new MainAdepter(options);
        recyclerView.setAdapter(mainAdepter);

        FirebaseDatabase.getInstance().getReference().child("healthcondition")
        ...
        mainAdepter.setOnItemClickListener(model -> {
            Intent intent = new Intent(HealthConditionActivity.this, DetailsViewActivity.class);
