...
public class AccessoriesWearablesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accessories_wearables);
        ...
        FirebaseRecyclerOptions<MainModel> options = new FirebaseRecyclerOptions.Builder<MainModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("accessoriesandwearables"), MainModel.class)
                .build();

        mainAdepter = new MainAdepter(options);
        recyclerView.setAdapter(mainAdepter);

        FirebaseDatabase.getInstance().getReference().child("accessoriesandwearables")
        ...
        mainAdepter.setOnItemClickListener(model -> {
            Intent intent = new Intent(AccessoriesWearablesActivity.this, DetailsViewActivity.class);
