...
public class SkinCareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<MainModel> options = new FirebaseRecyclerOptions.Builder<MainModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("skincare"), MainModel.class)
                .build();

        mainAdepter = new MainAdepter(options);
        recyclerView.setAdapter(mainAdepter);

        FirebaseDatabase.getInstance().getReference().child("skincare")
        ...
        mainAdepter.setOnItemClickListener(model -> {
            Intent intent = new Intent(SkinCareActivity.this, DetailsViewActivity.class);
